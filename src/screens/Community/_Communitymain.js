...
import { Row, Col, Container, Content,Icon as BookmarkIcon } from 'native-base';
...
export default function _Communitymain(props) {
    ...
    const renderRow = ({item, index}) =>{
        ...
        return (
            ...
            borderRadius : 10,
            padding : 5,
            shadowRadius: 5, borderColor:'#ccc', marginHorizontal:7, marginTop:12, paddingRight:8, paddingTop:9, paddingBottom:10, paddingLeft:11, backgroundColor }}>
                ...
                <Row style={{marginTop:20}}>
                    ...
                    <Col  style={{flex:0.1, alignItems:'flex-end'}}>
                        {item.isFavoriteArticle ?  
                        <BookmarkIcon onPress={()=>markFavorite(item)} name="bookmark" 
                        type="FontAwesome" style={{fontSize:20, color:theme.colors.green, height: 22.75, width: 16.25}}/>
                        :
